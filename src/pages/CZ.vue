<template>
    <div style="position: relative" class="flex column fit">
        <!-- class="echarts-box" -->
        <div id="chartDiv" style="height:100%; width:calc(100% - 600px)">
            <div>
            ...
            <!-- position: absolute;top: 920px;left: 70px -->
        </div>
        <div id="testtext" style="width: 600px; height:100%;" class="q-pl-md">
...
export default {
    ...
    setup () {
        ...
        async function SetOption (start, end) {
            ...
            console.log('xxxxxxxx', document.getElementById('chartDiv').clientWidth,);
            const divW = document.getElementById('chartDiv').clientWidth
            const divH = document.getElementById('chartDiv').clientHeight
            var resizeCharDom = function () {
                chartDom.style.width = divW + 'px'
                chartDom.style.height = divH * 0.75 + 'px'
            }
            screen_length.value = divW - 265
            screen_height.value = divH * 0.8
            ...
            channel_array.value.forEach(function (channel_name, idx) {
                ...
                //8.35   越大整體越縮小
                ctx.fillText(channel_name, 10, (idx * 295) / 7 + 10);
            })
            ...
            I.rect(screen_length.value - 360, 40, 10, 17);
            I.fill()
            I.stroke()
            I.font = '15px self'
            I.fillText('200uv', screen_length.value - 340, 55)
            // DerawTimeLine
            timeline(screen_length.value, 1, 1, rangeArray)
        }
        //Loading
