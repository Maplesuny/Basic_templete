...
import { sharpCollectionsBookmark, sharpSignalCellularAlt } from '@quasar/extras/material-icons-sharp'
...
export default {
    ...
    setup () {
        ...
        const json_url = 'http://127.0.0.1/api/v1/eegData?start_time=' + start_time.value + '&end_time=' + end_time.value + '&montage_type=' + montage_type.value
        ...
        function showLoading () {
            $q.loading.show({
                message: 'Loading something Data. Please wait...',
